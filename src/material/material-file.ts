...
//Generates approval icon
export const material_file_approval_rounded = generate_function(
  "material_file_approval_rounded",
...
//Generates attach_email icon
export const material_file_attach_email_rounded = generate_function(
  "material_file_attach_email_rounded",
...
//Generates attachment icon
export const material_file_attachment_rounded = generate_function(
  "material_file_attachment_rounded",
  '<svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M17.75 16H7.17c-2.09 0-3.95-1.53-4.15-3.61C2.79 10.01 4.66 8 7 8h12.36c1.31 0 2.5.94 2.63 2.24.15 1.5-1.02 2.76-2.49 2.76H9c-.55 0-1-.45-1-1s.45-1 1-1h8.75c.41 0 .75-.34.75-.75s-.34-.75-.75-.75H9.14c-1.31 0-2.5.94-2.63 2.24-.15 1.5 1.02 2.76 2.49 2.76h10.33c2.09 0 3.95-1.53 4.15-3.61.23-2.39-1.64-4.39-3.98-4.39H7.23c-2.87 0-5.44 2.1-5.71 4.96-.3 3.29 2.26 6.04 5.48 6.04h10.75c.41 0 .75-.34.75-.75s-.34-.75-.75-.75z"/></svg>',
);

//Generates cloud icon
export const material_file_cloud_rounded = generate_function(
  "material_file_cloud_rounded",
...
//Generates cloud_circle icon
export const material_file_cloud_circle_rounded = generate_function(
  "material_file_cloud_circle_rounded",
...
//Generates cloud_done icon
export const material_file_cloud_done_rounded = generate_function(
  "material_file_cloud_done_rounded",
...
//Generates cloud_download icon
export const material_file_cloud_download_rounded = generate_function(
  "material_file_cloud_download_rounded",
  '<svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19.35 10.04C18.67 6.59 15.64 4 12 4 9.11 4 6.6 5.64 5.35 8.04 2.34 8.36 0 10.91 0 14c0 3.31 2.69 6 6 6h13c2.76 0 5-2.24 5-5 0-2.64-2.05-4.78-4.65-4.96zM17 13l-4.65 4.65c-.2.2-.51.2-.71 0L7 13h3V9h4v4h3z"/></svg>',
);

//Generates cloud_off icon
export const material_file_cloud_off_rounded = generate_function(
  "material_file_cloud_off_rounded",
...
//Generates cloud_queue icon
export const material_file_cloud_queue_rounded = generate_function(
  "material_file_cloud_queue_rounded",
  '<svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19.35 10.04C18.67 6.59 15.64 4 12 4 9.11 4 6.6 5.64 5.35 8.04 2.34 8.36 0 10.91 0 14c0 3.31 2.69 6 6 6h13c2.76 0 5-2.24 5-5 0-2.64-2.05-4.78-4.65-4.96zM19 18H6c-2.21 0-4-1.79-4-4s1.79-4 4-4h.71C7.37 7.69 9.48 6 12 6c3.04 0 5.5 2.46 5.5 5.5v.5H19c1.66 0 3 1.34 3 3s-1.34 3-3 3z"/></svg>',
);

//Generates cloud_sync icon
export const material_file_cloud_sync_rounded = generate_function(
  "material_file_cloud_sync_rounded",
...
//Generates cloud_upload icon
export const material_file_cloud_upload_rounded = generate_function(
  "material_file_cloud_upload_rounded",
  '<svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19.35 10.04C18.67 6.59 15.64 4 12 4 9.11 4 6.6 5.64 5.35 8.04 2.34 8.36 0 10.91 0 14c0 3.31 2.69 6 6 6h13c2.76 0 5-2.24 5-5 0-2.64-2.05-4.78-4.65-4.96zM14 13v4h-4v-4H7l4.65-4.65c.2-.2.51-.2.71 0L17 13h-3z"/></svg>',
);

//Generates create_new_folder icon
export const material_file_create_new_folder_rounded = generate_function(
  "material_file_create_new_folder_rounded",
...
//Generates difference icon
export const material_file_difference_rounded = generate_function(
  "material_file_difference_rounded",
...
//Generates download icon
export const material_file_download_rounded = generate_function(
  "material_file_download_rounded",
  '<svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M16.59 9H15V4c0-.55-.45-1-1-1h-4c-.55 0-1 .45-1 1v5H7.41c-.89 0-1.34 1.08-.71 1.71l4.59 4.59c.39.39 1.02.39 1.41 0l4.59-4.59c.63-.63.19-1.71-.7-1.71zM5 19c0 .55.45 1 1 1h12c.55 0 1-.45 1-1s-.45-1-1-1H6c-.55 0-1 .45-1 1z"/></svg>',
);

//Generates download_done icon
export const material_file_download_done_rounded = generate_function(
  "material_file_download_done_rounded",
...
//Generates download_for_offline icon
export const material_file_download_for_offline_rounded = generate_function(
  "material_file_download_for_offline_rounded",
...
//Generates drive_file_move_rtl icon
export const material_file_drive_file_move_rtl_rounded = generate_function(
  "material_file_drive_file_move_rtl_rounded",
...
//Generates drive_file_rename_outline icon
export const material_file_drive_file_rename_outline_rounded = generate_function(
  "material_file_drive_file_rename_outline_rounded",
...
//Generates drive_folder_upload icon
export const material_file_drive_folder_upload_rounded = generate_function(
  "material_file_drive_folder_upload_rounded",
...
//Generates file_download icon
export const material_file_file_download_rounded = generate_function(
  "material_file_file_download_rounded",
...
//Generates file_download_done icon
export const material_file_file_download_done_rounded = generate_function(
  "material_file_file_download_done_rounded",
...
//Generates file_download_off icon
export const material_file_file_download_off_rounded = generate_function(
  "material_file_file_download_off_rounded",
...
//Generates file_open icon
export const material_file_file_open_rounded = generate_function(
  "material_file_file_open_rounded",
...
//Generates file_upload icon
export const material_file_file_upload_rounded = generate_function(
  "material_file_file_upload_rounded",
...
export const material_file_folder_rounded = generate_function(
  "material_file_folder_rounded",
  '<svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M10.59 4.59C10.21 4.21 9.7 4 9.17 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2h-8l-1.41-1.41z"/></svg>',
);

//Generates folder_copy icon
export const material_file_folder_copy_rounded = generate_function(
  "material_file_folder_copy_rounded",
  '<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24"><g><rect fill="none" height="24" width="24"/><rect fill="none" height="24" width="24"/></g><g><g><path d="M2,6L2,6C1.45,6,1,6.45,1,7v12c0,1.1,0.9,2,2,2h16c0.55,0,1-0.45,1-1v0c0-0.55-0.45-1-1-1H3V7C3,6.45,2.55,6,2,6z"/><path d="M21,4h-7l-1.41-1.41C12.21,2.21,11.7,2,11.17,2H7C5.9,2,5.01,2.9,5.01,4L5,15c0,1.1,0.9,2,2,2h14c1.1,0,2-0.9,2-2V6 C23,4.9,22.1,4,21,4z"/></g></g></svg>',
);

//Generates folder_delete icon
export const material_file_folder_delete_rounded = generate_function(
  "material_file_folder_delete_rounded",
  '<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24"><g><rect fill="none" height="24" width="24"/></g><g><path d="M16.5,15.5h-2v-4h2V15.5z M20,6h-8l-1.41-1.41C10.21,4.21,9.7,4,9.17,4H4C2.9,4,2.01,4.9,2.01,6L2,18c0,1.1,0.9,2,2,2h16 c1.1,0,2-0.9,2-2V8C22,6.9,21.1,6,20,6z M18.25,11.5H18v4c0,0.83-0.67,1.5-1.5,1.5h-2c-0.83,0-1.5-0.67-1.5-1.5v-4h-0.25 c-0.41,0-0.75-0.34-0.75-0.75c0-0.41,0.34-0.75,0.75-0.75h1.75V9.75C14.5,9.34,14.84,9,15.25,9h0.5c0.41,0,0.75,0.34,0.75,0.75V10 h1.75c0.41,0,0.75,0.34,0.75,0.75C19,11.16,18.66,11.5,18.25,11.5z"/></g></svg>',
);

//Generates folder_off icon
export const material_file_folder_off_rounded = generate_function(
  "material_file_folder_off_rounded",
...
//Generates folder_open icon
export const material_file_folder_open_rounded = generate_function(
  "material_file_folder_open_rounded",
...
//Generates folder_shared icon
export const material_file_folder_shared_rounded = generate_function(
  "material_file_folder_shared_rounded",
  '<svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M20 6h-8l-1.41-1.41C10.21 4.21 9.7 4 9.17 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2zm-5 3c1.1 0 2 .9 2 2s-.9 2-2 2-2-.9-2-2 .9-2 2-2zm4 8h-8v-1c0-1.33 2.67-2 4-2s4 .67 4 2v1z"/></svg>',
);

//Generates folder_zip icon
export const material_file_folder_zip_rounded = generate_function(
  "material_file_folder_zip_rounded",
  '<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24"><g><rect fill="none" height="24" width="24"/></g><g><path d="M20,6h-8l-1.41-1.41C10.21,4.21,9.7,4,9.17,4H4C2.9,4,2.01,4.9,2.01,6L2,18c0,1.1,0.9,2,2,2h16c1.1,0,2-0.9,2-2V8 C22,6.9,21.1,6,20,6z M18,12h-2v2h2v2h-2v2h-2v-2h2v-2h-2v-2h2v-2h-2V8h2v2h2V12z"/></g></svg>',
);

//Generates format_overline icon
export const material_file_format_overline_rounded = generate_function(
  "material_file_format_overline_rounded",
...
//Generates grid_view icon
export const material_file_grid_view_rounded = generate_function(
  "material_file_grid_view_rounded",
  '<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24"><g><rect fill="none" height="24" width="24"/></g><g><g><path d="M5,11h4c1.1,0,2-0.9,2-2V5c0-1.1-0.9-2-2-2H5C3.9,3,3,3.9,3,5v4C3,10.1,3.9,11,5,11z"/><path d="M5,21h4c1.1,0,2-0.9,2-2v-4c0-1.1-0.9-2-2-2H5c-1.1,0-2,0.9-2,2v4C3,20.1,3.9,21,5,21z"/><path d="M13,5v4c0,1.1,0.9,2,2,2h4c1.1,0,2-0.9,2-2V5c0-1.1-0.9-2-2-2h-4C13.9,3,13,3.9,13,5z"/><path d="M15,21h4c1.1,0,2-0.9,2-2v-4c0-1.1-0.9-2-2-2h-4c-1.1,0-2,0.9-2,2v4C13,20.1,13.9,21,15,21z"/></g></g></svg>',
);

//Generates newspaper icon
export const material_file_newspaper_rounded = generate_function(
  "material_file_newspaper_rounded",
  '<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24"><g><rect fill="none" height="24" width="24"/><rect fill="none" height="24" width="24"/></g><g><path d="M21.15,3.85l-0.82,0.82l-0.95-0.96c-0.39-0.39-1.02-0.39-1.42,0L17,4.67l-0.96-0.96c-0.39-0.39-1.03-0.39-1.42,0 l-0.95,0.96l-0.96-0.96c-0.39-0.39-1.02-0.39-1.41,0l-0.96,0.96L9.38,3.71c-0.39-0.39-1.02-0.39-1.42,0L7,4.67L6.04,3.71 c-0.39-0.39-1.03-0.39-1.42,0L3.67,4.67L2.85,3.85C2.54,3.54,2,3.76,2,4.21V19c0,1.1,0.9,2,2,2l16,0c1.1,0,2-0.9,2-2V4.21 C22,3.76,21.46,3.54,21.15,3.85z M11,19H4v-6h7V19z M20,19h-7v-2h7V19z M20,15h-7v-2h7V15z M20,11H4V8h16V11z"/></g></svg>',
);

//Generates request_quote icon
export const material_file_request_quote_rounded = generate_function(
  "material_file_request_quote_rounded",
...
//Generates rule_folder icon
export const material_file_rule_folder_rounded = generate_function(
  "material_file_rule_folder_rounded",
...
//Generates snippet_folder icon
export const material_file_snippet_folder_rounded = generate_function(
  "material_file_snippet_folder_rounded",
...
//Generates text_snippet icon
export const material_file_text_snippet_rounded = generate_function(
  "material_file_text_snippet_rounded",
...
//Generates topic icon
export const material_file_topic_rounded = generate_function(
  "material_file_topic_rounded",
...
//Generates upload icon
export const material_file_upload_rounded = generate_function(
  "material_file_upload_rounded",
...
//Generates upload_file icon
export const material_file_upload_file_rounded = generate_function(
  "material_file_upload_file_rounded",
...
//Generates workspaces icon
export const material_file_workspaces_rounded = generate_function(
  "material_file_workspaces_rounded",
